...
> **Note**: The default location in the PVC is `/profiling_results/disagg.yaml`. If you don't inject a config, the profiler will fall back to the built-in config at `/workspace/examples/engines/vllm/kubernetes/disagg.yaml`.
