...
The scripts in the `examples/engines/<backend>/single-node` folder like [agg.sh](../../../examples/engines/vllm/single-node/agg.sh) demonstrate how you can serve your models locally.
The corresponding YAML files like [agg.yaml](../../../examples/engines/vllm/kubernetes/agg.yaml) show you how you could create a kubernetes deployment for your inference graph.
...
- **Development / Testing**
  Use [`agg.yaml`](../../../examples/engines/vllm/kubernetes/agg.yaml) as the base configuration.

- **Production with Load Balancing**
  Use [`agg_router.yaml`](../../../examples/engines/vllm/kubernetes/agg_router.yaml) to enable scalable, load-balanced inference.

- **High Performance / Disaggregated Deployment**
  Use [`disagg_router.yaml`](../../../examples/engines/vllm/kubernetes/disagg_router.yaml) for maximum throughput and modular scalability.
